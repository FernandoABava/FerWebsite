...
*/
  ...
  f1 = 1. - dibujarFigura(p, fondo * noise(uv * 5. + time * .1) * .5);
...
void main() {
  ...
  verde = cambiarFase(uv, 0.95);
  azul = cambiarFase(uv, 0.05);
